...
export default function AboutScreen() {
  ...
  const openWeb = async (path: string) => {
    ...
    try {
      ...
      if (path.includes('privacy')) router.push('/legal/privacy');
  ...
  return (
    <SafeAreaView style={styles.safeArea}>
      ...
      <ScrollView contentContainerStyle={styles.content}>
        <Text style={styles.brand}>{APP_LEGAL_NAME} Rider</Text>
        <Text style={styles.tagline}>Pickup and delivery partner app</Text>
        <Text style={styles.body}>
          Review our Privacy Policy and Terms of Service below. These apply to your
          rider account and use of the app.
        </Text>
